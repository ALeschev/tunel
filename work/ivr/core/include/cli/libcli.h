...
struct cli_command *cli_register_command_ex(struct cli_def *cli, struct cli_command *parent, char *command, int (*callback)(struct cli_def *, char *, char **, int), int privilege, int mode, char *help, char *help_ex);
...
void cli_print_lite(struct cli_def *cli, char *str);
